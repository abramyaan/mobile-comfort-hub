...
export const cabins: Cabin[] = [
  ...
  },
  {
    ...
    manufacturer: "Россия",
    warranty: "12 месяцев",
    description: "Надежное решение для строительных объектов и дачных участков. Корпус из ударопрочного полиэтилена, надежная вентиляция.",
    images: [zelen1, zelen2, zelen3],
  },
  {
    id: "premium",
    name: "Туалетная кабина евростандарт\nЦвет: зеленый, синий, серый",
    price: 36000,
    rent: 8000,
    size: "115 × 115 × 220 см",
    weight: "70 кг",
    ...
    manufacturer: "Россия",
    warranty: "12 месяцев",
    description: "Максимальная прочностью пластика усиленная кабина с двойной дверью. Включает рукомойник, мягкое сиденье и дополнительную фурнитуру.",
    images: [lux1, lux2],
  },
];
